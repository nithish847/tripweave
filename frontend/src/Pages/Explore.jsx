...
// const tripTypes = ["Nature", "Heritage", "Adventure", "Beach", "Budget", "Luxury"];

// const Explore = () => {
//   const [query, setQuery] = useState("");           // search input
//   const [places, setPlaces] = useState([]);         // search results
//   const [allStatesData, setAllStatesData] = useState([]); // all states
//   const [filteredStates, setFilteredStates] = useState([]); // filtered states
//   const [loading, setLoading] = useState(false);
//   const [error, setError] = useState(null);
//   const [activeType, setActiveType] = useState(""); // Start with no active type

//   const navigate = useNavigate();

//   // Fetch all places and extract unique states
...
//             name: place.State,
//             image: place.Wikipedia_Image || place.Image || "/images/default-travel.jpg"
//           });
//         }
//       });
...
//       setFilteredStates(statesArray); // initially show all states
//     } catch (err) {
...
//   // Fetch places for search/filter
...
//       {/* Hero Section */}
//       <div className="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-6 py-16 md:py-24 rounded-b-3xl">
//         <div className="absolute inset-0 bg-black/20"></div>
//         <div className="relative z-10 max-w-6xl mx-auto text-center">
//           <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
//             Explore <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-400">Incredible India</span>
//           </h1>
...
//             <Search className="absolute left-6 top-1/2 transform -translate-y-1/2 text-gray-400 z-10" size={20} />
//             <input
//               type="text"
//               value={query}
//               onChange={(e) => setQuery(e.target.value)}
//               placeholder="Search by state or place (e.g., Kerala)"
//               className="w-full pl-14 pr-14 py-4 rounded-2xl bg-white/95 backdrop-blur-sm text-gray-700 placeholder-gray-500 border-0 shadow-xl focus:outline-none focus:ring-4 focus:ring-white/30 text-lg"
//             />
//             <button
//               onClick={() => fetchPlaces(query.trim(), activeType)}
//               className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white p-3 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105"
//             >
//               <Search size={18} />
//             </button>
//           </div>
...
//             <Sparkles className="text-indigo-500" size={24} /> Trip Categories
//           </h2>
//           <div className="flex gap-3 overflow-x-auto pb-4 hide-scrollbar snap-x snap-mandatory">
//             <button
//               onClick={() => setActiveType("")}
//               className={`snap-start relative px-6 py-3 rounded-2xl text-sm font-semibold whitespace-nowrap transition-all duration-300 transform hover:scale-105 ${
//                 activeType === ""
//                   ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg"
//                   : "bg-white text-gray-700 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 hover:text-indigo-700 shadow-md border border-gray-100"
//               }`}
//             >
//               All Types
//               {activeType === "" && <div className="absolute -top-1 -right-1 w-3 h-3 bg-yellow-400 rounded-full animate-ping"></div>}
//             </button>
...
//               >
//                 {type}
//                 {activeType === type && <div className="absolute -top-1 -right-1 w-3 h-3 bg-yellow-400 rounded-full animate-ping"></div>}
//               </button>
//             ))}
//           </div>
//         </div>
...
//           <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
//             <Sparkles className="text-indigo-500" size={24} /> States
//           </h2>
//           {loading ? (
...
//             <p className="text-center text-gray-500 py-8">No states found</p>
//           ) : (
...
//                   className="cursor-pointer rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group"
//                 >
...
//                   </div>
//                   <div className="bg-white p-4 text-center font-medium text-gray-800">
//                     {state.name}
//                   </div>
//                 </div>
//               ))}
...
//         <div className="space-y-6">
//           <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
//             <MapPin className="text-red-500" size={24} /> Destinations
//           </h2>
//           {loading ? (
//             <div className="flex justify-center items-center py-12">
//               <Loader className="animate-spin text-indigo-500" size={32} />
...
//                   <DestinationCard
//                     name={place.Name}
//                     image={place.Image || place.Wikipedia_Image || "/images/default-travel.jpg"}
//                     tagline={place.Significance || place.Type}
...
//             Uncover hidden gems, ancient wonders, and breathtaking landscapes across 28 states
//           </p>
...
const Explore = () => {
  ...
  // Fetch unique states from backend
  const fetchStates = async () => {
    setLoading(true);
    setError(null);
    try {
